...
- Versioned UTF-16 text snapshots, incremental edits, multi-document language sessions, stable token/subtree identities, grammar replacement, and reuse metrics.
