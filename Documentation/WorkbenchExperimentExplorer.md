...
workspace and **Open Experiment** command for schema-1 artifacts produced by
Grammar-REPL 0.5.0.
...
Workbench deliberately does not recompute the experiment fingerprint or rerun
parser engines. Those operations require Grammar-REPL's complete grammar and
engine semantics and remain owned by `grammar-repl-experiment verify`. The
...
0.5.0, including accepted generalized forests, explicit LL(1) unsupported
