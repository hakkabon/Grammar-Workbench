...
for REQUIRED in '"requestID":"smoke-capabilities"' '"status":"success"' '"json-lines"' '"sessionOpen"' '"languageKitValidate"' '"semanticLanguageKits"' '"graphLayout"' '"graphVisualizationPlatform"' '"crossPlatformCoreSeparation"'; do
    case "$OUTPUT" in
        *"$REQUIRED"*) ;;
