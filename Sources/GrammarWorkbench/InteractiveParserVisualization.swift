...
public enum GrammarParserVisualizationHTMLRenderer {
    public static func render(
        _ timeline: GrammarParserVisualizationTimeline,
        preferences: GrammarVisualPreferences = .init()
    ) throws -> String {
        let svg = GrammarGraphAdvancedSVGRenderer.render(timeline.layout, preferences: preferences)
