...
public struct GrammarToolingCapabilities: Hashable, Codable, Sendable {
    ...
    public static let current = Self(
        ...
        features: [
            ...
            "researchQualityDistribution": GrammarWorkbenchCapabilities.researchQualityDistribution,
            "executableGrammarAndParserLaws": GrammarWorkbenchCapabilities.executableGrammarAndParserLaws,
            "counterexampleDiscoveryAndMinimization": GrammarWorkbenchCapabilities.counterexampleDiscoveryAndMinimization,
            "recoveryTruthfulness": GrammarWorkbenchCapabilities.recoveryTruthfulness,
            "sharedCorpusV5": GrammarWorkbenchCapabilities.sharedCorpusV5,
            "ambiguityAwareSemanticConvergence": GrammarWorkbenchCapabilities.ambiguityAwareSemanticConvergence,
            ...
            "linuxDelivery": GrammarWorkbenchCapabilities.linuxDelivery,
