...
comparison cases report all ten engines across the 45-case corpus, concrete
derivation counts, portable-forest ambiguity, production identity, replay
milestones, and explicit LL(1) capability decisions. Command rendering,
